...
# title
st.markdown("<h1 style='text-align: center;'>Ticker vs Date</h1>", unsafe_allow_html=True)
...
# write_to_kafka('stocks data', all_stock_pull('1d', 90), STOCKS_DATA_KAFKA_TOPIC)
