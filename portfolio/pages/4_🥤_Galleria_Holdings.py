...
with architectures:
    ...
    st.image('portfolio/pages/galleria.png')
with final_result:
    st.write("""
    ...
    sales = pd.read_csv('portfolio/pages/data/galleria/sales.csv')
    ...
    outlet = pd.read_csv('portfolio/pages/data/galleria/outlet.csv')
    ...
    name = pd.read_csv('portfolio/pages/data/galleria/name.csv')
    ...
    group = pd.read_csv('portfolio/pages/data/galleria/group.csv')
