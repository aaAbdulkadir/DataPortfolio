...
with architectures:
    ...
    st.image('portfolio/pages/cmc.png')
...
with final_result:
    ...
    performance_90d = pd.read_csv('portfolio/pages/data/cmc/best90days.csv')
    ...
    gainers = pd.read_csv('portfolio/pages/data/cmc/gainers.csv')
    losers = pd.read_csv('portfolio/pages/data/cmc/losers.csv')
    trending = pd.read_csv('portfolio/pages/data/cmc/bs4trending.csv')
    ...
    price_chart = pd.read_csv('portfolio/pages/data/cmc/pricechart.csv')
    ranked = pd.read_csv('portfolio/pages/data/cmc/ranked.csv')
